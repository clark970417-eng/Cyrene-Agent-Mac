...
export const memoryL2StatusFilter = document.getElementById("memory-l2-status-filter") as HTMLSelectElement | null;
export const memoryL2List = document.getElementById("memory-l2-list") as HTMLElement | null;
export const memoryTimelineToolbar = document.getElementById("memory-timeline-toolbar") as HTMLElement | null;
export const memoryTimelineView = document.getElementById("memory-timeline-view") as HTMLElement | null;
export const memoryGraphView = document.getElementById("memory-graph-view") as HTMLElement | null;
export const memoryGraphNodes = document.getElementById("memory-graph-nodes") as HTMLElement | null;
export const memoryGraphLines = document.getElementById("memory-graph-lines") as unknown as SVGSVGElement | null;
export const memoryGraphDetail = document.getElementById("memory-graph-detail") as HTMLElement | null;
export const memoryGraphEmpty = document.getElementById("memory-graph-empty") as HTMLElement | null;
export const memoryViewCount = document.getElementById("memory-view-count") as HTMLElement | null;
